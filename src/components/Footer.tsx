            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="space-y-4">
                        <h3 className="text-2xl font-serif font-bold text-gray-900 dark:text-white">
                            Twinkle <span className="text-primary-500">Makeover</span>
                        </h3>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="flex items-center text-gray-600 dark:text-gray-400 text-sm">
                                <FiMail className="mr-2 text-primary-500" /> hello@twinklemakeover.in
                            </li>
                            <li className="flex items-center text-gray-600 dark:text-gray-400 text-sm">
                                <FiMapPin className="mr-2 text-primary-500" /> Bangalore, India
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800 text-center">
                    <p className="text-gray-500 dark:text-gray-500 text-sm">
                        &copy; {new Date().getFullYear()} Twinkle Makeover Makeup Artistry. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
